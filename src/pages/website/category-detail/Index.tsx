...
const Index = () => {
    ...
    const category = Object.entries(courseCategories).find(([_, category]) => category.id === Number(id))?.[1];

    const categoryCourses = coursesData.filter((course) => (course.category.id === Number(id)) && course.isBestSelling)
                                    ...
                                    {tools.map((tool) => (
                                        <CarouselItem key={tool.id}
                                            ...
                                            <Card
                                                ...
                                                <div className="font-medium text-base text-gray-900">{tool.name}</div>
