                ...
                <div className="section-layout">
                    <div className="flex flex-col">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                <p>
                                    <span className="text-gray-900 font-medium">{paginatedCourses.length} </span>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className={showFilters ? "md:w-3/4" : "w-full"}>
                            {/* Course Cards */}
                            <div className={`grid gap-6 ${showFilters ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'}`}>
