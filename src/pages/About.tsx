                ...
                <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="max-w-[535px] w-full ml-auto">
                        ...
                        <p>
                            ...
                            Choose agility over dogma. Embrace and drive change. We need to wipe the slate clean and begin with bold, radical thinking.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="container overflow-visible">
                <div className="flex flex-col md:flex-row gap-28 items-center">
                    <div className="max-w-[424px] shrink-0 w-full">
                        ...
                        <Button>
                            Join Our Team <ArrowRight className="" />
                        </Button>
                    </div>
                                ...
                                <div className="relative">
                                    <div className="flex flex-col gap-5 bg-gray-50 p-6 text-gray-900">
                                        ...
                                        <p className="text-lg text-center">
                                            Eduguard fit us like a glove. Their team curates fresh, up-to-date courses
                                    ...
                                    <div className="flex flex-col items-center ">
                                        ...
                                        <div className="flex flex-col gap-1.5 items-center mt-5">
                                            ...
                                            <div className="text-sm text-gray-500">
                                                {item.designation} of <span className="text-blue-600 font-medium">{item.name}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
